		...
		<section class="content">
			...
			<div class="box">
				...
				<div class="box-body box-form">
					...
					<g:form class="form-horizontal" novalidate="novalidate" name="anexoChamadoInstanceForm" url="[resource:anexoChamadoInstance, action:'save']" >
						<g:render template="form"/>
					</g:form>
				</div>
				<div class="box-footer clearfix">
					<button type="submit" form="anexoChamadoInstanceForm" class="btn btn-success pull-right"><i class="fa fa-check"></i> <g:message code="default.button.create.label"  default="Create"/></button>
				</div>
			</div>
		</section>
	<g:javascript>
