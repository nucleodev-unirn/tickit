...
<div class="form-group ${hasErrors(bean: chamadoInstance, field: 'setorSolicitante', 'error')} required">
...
<div class="form-group ${hasErrors(bean: chamadoInstance, field: 'titulo', 'error')} required">
...
<div class="form-group ${hasErrors(bean: chamadoInstance, field: 'nomeSolicitante', 'error')} required">
...
<div class="form-group ${hasErrors(bean: chamadoInstance, field: 'emailSolicitante', 'error')} required">
...
<div class="form-group ${hasErrors(bean: chamadoInstance, field: 'descricao', 'error')} required">
...
<div class="form-group ${hasErrors(bean: chamadoInstance, field: 'avaliacao', 'error')} required">
...
<div class="form-group ${hasErrors(bean: chamadoInstance, field: 'tags', 'error')} required">
...
<div class="form-group ${hasErrors(bean: chamadoInstance, field: 'ativo', 'error')} ">
...
<div class="form-group ${hasErrors(bean: chamadoInstance, field: 'ultimaAtualizacaoPor', 'error')} required">
...
<div class="form-group ${hasErrors(bean: chamadoInstance, field: 'desativadoPor', 'error')} required">
...
<div class="form-group ${hasErrors(bean: chamadoInstance, field: 'dataDesativacao', 'error')} required">
