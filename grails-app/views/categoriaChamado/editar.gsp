		...
		<section class="content">
			...
			<div class="box">
				...
				<div class="box-body box-form">
					...
					<g:form class="form-horizontal" novalidate="novalidate" name="categoriaChamadoInstanceForm" url="[resource:categoriaChamadoInstance, action:'update']" method="PUT" >
						<g:hiddenField name="version" value="${categoriaChamadoInstance?.version}" />
						<g:render template="form"/>
					</g:form>
				</div>
				<div class="box-footer clearfix">
					<button type="submit" form="categoriaChamadoInstanceForm" class="btn btn-success pull-right"><i class="fa fa-check"></i> <g:message code="default.button.update.label"  default="Update"/></button>
				</div>
			</div>
		</section>
	<g:javascript>
